...
PRED_DIR = "/home/sparackal/sam/coarseloop"                                     # o_<id>_<suffix>_semantic.png
...
gt_pattern = re.compile(r"mSemSegmentation_(\d+)_coarse\.png$")
gt_files = {}
...
with open("miou_per_class_by_daytime.csv", "w", newline="") as csvfile:
...
print("\nSaved per-class, per-suffix mIoU results to miou_per_class_by_daytime.csv")