...
for img_path in image_paths:
    ...
    annotated_path = os.path.join(outputfolder, f"{img_name}_predcoarse15.jpg")
...
output_json = os.path.join(outputfolder,"coarse_predictions15.json")
