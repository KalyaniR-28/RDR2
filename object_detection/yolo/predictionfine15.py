...
for img_path in image_paths:
    ...
    annotated_path = os.path.join(outputfolder, f"{img_name}_predfine15.jpg")
...
output_json = os.path.join(outputfolder,"fine_predictions15.json")
