...
outputfolder = "./predcoarse"
os.makedirs(outputfolder, exist_ok=True)

with open("gt_Coarse_labelIds_mapping.json", "r") as file:
...
for img_path in image_paths:
    ...
    results = model.predict(img_path, agnostic_nms=True)# you can specify the confidence threshhold here "conf=0.15"
    annotated_path = os.path.join(outputfolder, f"{img_name}_predcoarse.jpg")
...
output_json = os.path.join(outputfolder,"coarse_predictions.json")
